...
### Newfoundland Caribou Herds Inset

This uses data from Open Street Map, Natural Earth and Newfoundland Government and packages: `osmdata`, `rnaturalearth`, `rnaturalearthhires`, `sf`, `data.table`, `ggrepel` and `ggplot`. 


Reproducing: run  `03-newfoundland-prep.R`, `15-manitoba-prep.R` and `15-middle-ridge-prep.R` to generate the MR and NL data and `24-newfoundland-caribou-herds-inset-figure.R` to generate the figure. 

```{r}
knitr::include_graphics('graphics/24-newfoundland-caribou-herds-inset.png')
```
