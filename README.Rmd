...
This uses data from Open Street Map and six packages: `osmdata`, `sf`, `data.table` and `ggplot`. 
...
This uses data from Natural Earth and six packages: `rnaturalearth`, `sf`, `data.table` and `ggplot`. 
